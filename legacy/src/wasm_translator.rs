...
//!
//! Users can extend the filesystem by dropping WASM modules into /settrans/
...
/// Special synthetic files for managing translators
pub mod management_files {
    use super::*;
