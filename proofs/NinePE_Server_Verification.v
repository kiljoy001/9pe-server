...
Inductive NinePeeMessage : Type :=
  | Version : nat -> string -> NinePeeMessage
  | VersionR : nat -> string -> NinePeeMessage
  | Attach : Fid -> Fid -> string -> string -> NinePeeMessage
  | AttachR : Qid -> NinePeeMessage
  | Walk : Fid -> Fid -> list string -> NinePeeMessage
  | WalkR : list Qid -> NinePeeMessage
  | Open : Fid -> nat -> NinePeeMessage
  | OpenR : Qid -> nat -> NinePeeMessage
  | Read : Fid -> nat -> nat -> NinePeeMessage
  | ReadR : list nat -> NinePeeMessage
  | Write : Fid -> nat -> list nat -> NinePeeMessage
  | WriteR : nat -> NinePeeMessage
  | Clunk : Fid -> NinePeeMessage
  | ClunkR : NinePeeMessage
  | Error : string -> nat -> NinePeeMessage.
...
Definition process_message (s : ServerState) (msg : NinePeeMessage)
  : (ServerState * NinePeeMessage) :=
  match msg with
