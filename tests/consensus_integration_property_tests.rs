//! Integration property tests for consensus + file operations
...
/// Strategy for generating individual file operations
...
#[tokio::test]
async fn prop_complete_file_workflow_with_consensus() {
...
#[tokio::test]
async fn prop_consensus_partial_failure_recovery() {
